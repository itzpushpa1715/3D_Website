...
export const useStore = create<Store>((set, get) => ({
  ...
  profile: {
    ...
    bio: 'Passionate automation engineer bridging technology and innovation through cutting-edge robotics solutions. Specializing in PLC programming, industrial automation, and intelligent control systems.',
    location: 'Jyvaskyla, Finland',
